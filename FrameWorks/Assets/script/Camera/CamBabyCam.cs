...
// This is the fucking class/script to the 3rd person camera features.
public class CamBabyCam : MonoBehaviour 
{
    //variable commented for idiot
    ...
    public bool ViewingPosCheck (Vector3 checkPos, float deltaPlayerHeight)
	{
		// Cast target.
    ...
    public bool ReverseViewingPosCheck(Vector3 checkPos, float deltaPlayerHeight, float maxDistance)
	{
        // Cast origin.
        RaycastHit hit;
